...
def verified_user():
    verified_user = User.objects.create_user(
        email='verifieduser@parham.com',
        password='parham654321',
        is_verified=True
    )
...
def unverified_user():
    unverified_user = User.objects.create_user(
        email='unverifieduser@parham.com',
        password='parham654321',
        is_verified=False
    )
...
def user0_task(user0):
    user0_task = Task.objects.create(author=user0, title='test', context='test', is_complete=False)
    return user0_task
