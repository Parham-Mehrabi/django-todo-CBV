...
class TestTaskDetailsApi:
    ...
    def test_get_task_details_verified_user(self, api_client, verified_user, user_task, user0_task, user0):
    ...
    def test_get_task_details_unverified_user_403(self, api_client, unverified_user,
                                                  unverified_user_task, user0_task, user0):
        """ a verified user try to get details for its own task, someone else's task and a non-exist task"""

        # user's task
        url = reverse('todo:api-v1:tasks-detail', kwargs={'pk': unverified_user_task.id})
...
class TestTaskDetailsDeletePutPatchApi:
    ...
    def test_delete_task_api_unverified(self, api_client, unverified_user_task, unverified_user):
